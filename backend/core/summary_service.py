...
class ConversationEvent:
    ...
    timestamp: datetime
    event_type: str  # 'user_identified', 'appointment_booked', 'appointment_viewed', etc.
...
class SummaryGenerator:
    ...
    def _generate_summary_text(tracker: ConversationTracker) -> str:
        ...
        if tracker.appointments_viewed and not (tracker.appointments_booked or 
                                                 tracker.appointments_modified or 
                                                 tracker.appointments_cancelled):
